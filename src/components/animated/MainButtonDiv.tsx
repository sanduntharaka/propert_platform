...
export const MainButtonDiv = ({
  ...
  return (
    <motion.button
      className={clsx(
        "relative lg:w-32 lg:h-12 md:w-22 md:h-7 sm:w-32 sm:h-12 flex items-center justify-center gap-4 overflow-hidden bg-red-400 pl-3 pr-3 box-content",
        {
