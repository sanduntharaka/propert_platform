        ...
        <div className="flex gap-20 md:flex-row sm:flex-col md:pl-8 md:pr-8">
          <div className="md:w-2/3 flex flex-col gap-4 md:ml-0 md:mr-0 sm:ml-8 sm:mr-8 ">
            ...
            <div className="flex justify-between lg:text-xl md:text-tiny sm:text-xl">
              <p>
                For any inquiries or to schedule a property showing, please
                reach out to us. Our team is ready to assist you with all your
                real estate needs. Let us help you find your dream home!
              </p>
            </div>
          </div>
          ...
          <div className="md:w-1/3 flex flex-col gap-6 pt-2 pb-2 md:ml-0 md:mr-0 sm:ml-8 sm:mr-8">
            <div className="flex gap-4">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="lg:text-base md:text-[10px] sm:text-base font-light">
                  hello@leighbrook.com
                </p>
              </div>
            </div>
            <div className="flex gap-4">
