      ...
      <div className="max-w-[1440px] ml-auto mr-auto lg:mb-28 md:mb-16  sm:mb-14  ">
        <div className="flex flex-col lg:gap-4 md:gap-[9px] sm:gap-4 lg:mb-14 md:mb-8 sm:mb-14 md:ml-0 md:mr-0 sm:ml-8 sm:mr-8">
          <div className="flex items-center gap-3">
            ...
            />
            <p className="lg:text-base sm:text-base md:text-tiny_2 ">
              Properties
            </p>
          </div>
          ...
          <div className="flex justify-between lg:text-xl md:text-tiny sm:text-xl">
            <p>Explore our exclusive featured properties today.</p>
        ...
        <div className="lg:h-[1771px] md:h-[1000px]  text-primary-button sm:grid">
          <div className="flex  md:flex-row sm:flex-col lg:gap-10 md:gap-3 sm:gap-10 w-full">
          ...
          <div className="flex justify-evenly md:flex-row sm:flex-col lg:gap-10 md:gap-3 sm:gap-10 w-full ">
            <div className="relative w-full lg:h-[577px] md:h-[334px]  md:overflow-hidden">
              <motion.div
                className="relative lg:w-full md:min-w-[390px]   lg:h-[450px] md:h-[260px]  sm:h-[400px] inset-0"
                initial={{ scale: 1.1 }}
                whileInView={{ scale: 1 }}
