...
const ArticleCard = () => (
    <div className="h-[26rem] w-full max-w-lg relative mx-auto md:mx-0 md:pl-0 md:pr-0 sm:pl-8 sm:pr-8">
        ...
        <div className="h-72 w-11/12 bg-primary-button text-white absolute top-28 p-8 flex flex-col justify-between">
            <div className="flex flex-col gap-4">
                ...
                <div className="font-gellix  font-bold md:prose sm:prose-sm">
                    <h6 className='text-white'>Understanding Current Market Trends</h6>
                </div>
            ...
            <div className="flex items-center gap-2">
                <MainButtonDiv ButtonText="Learn More" ButtonImage={<MdArrowOutward />} line={false} />
    ...
    return (
        <div className='max-w-[1440px] ml-auto mr-auto lg:mb-28 md:mb-16  sm:mb-14  flex flex-col gap-4 '>
            ...
            <div className="md:grid md:grid-cols-3 sm:grid-cols-1 gap-8">
                {[1, 2, 3, 4, 5, 6].map(i => <ArticleCard key={i} />)}
            </div>
