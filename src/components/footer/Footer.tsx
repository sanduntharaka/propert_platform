      ...
      <div className="bg-primary-button lg:pt-28 lg:pb-28 lg:pr-8 lg:pl-8  sm:pt-16 sm:pb-16  md:pt-16 md:pb-16  md:-mr-8 md:-ml-8  pl-8 pr-8">
        <div className=" text-white flex justify-between md:gap-[120px] sm:gap-12 md:flex-row sm:flex-col md:p-0 sm:p-5 ">
          <div className="flex-1 flex flex-col lg:gap-4 md:gap-3 sm:gap-4   ">
            <h4 className="font-bold">LEIGHBROOK</h4>
            <p className="lg:text-base md:text-[10px] sm:text-base">
              Stay informed with our latest features and updates.
            </p>
            <div>
              ...
              <p className="lg:text-base md:text-[8px] sm:text-base -mt-2">
          ...
          <div className="flex-1 flex lg:gap-8 md:gap-4 sm:gap-8 justify-between md:flex-row sm:flex-col ">
            <div className=" flex-1 flex flex-col lg:gap-4 md:gap-2 sm:gap-4 ">
              <p className="lg:text-base md:text-[10px] sm:text-base font-semibold">
                Quick Links
              </p>
              <p className="lg:text-sm md:text-[8px] sm:text-sm font-normal">
                About Us
              </p>
              <p className="lg:text-sm md:text-[8px] sm:text-sm font-normal">
                Contact Support
            ...
            <div className=" flex-1 flex flex-col lg:gap-4 md:gap-2 sm:gap-4 ">
              ...
              <div className="flex lg:gap-4 md:gap-4 sm:gap-4">
                <Image
                  src={facebook}
                  alt="facebook"
                  className="lg:w-6 lg:h-6 md:w-3 md:h-3 sm:w-6 sm:h-6"
                />
                <p className="lg:text-sm md:text-[8px] sm:text-sm font-normal">
                  Facebook
                </p>
        ...
        <div className=" text-white ">
          <Image
            src={footer_lg}
            alt="footer"
            className="mt-12 lg:inline md:hidden sm:hidden w-full"
          />
          <Image
            src={footer_tab}
            alt="footer"
            className="mt-12 lg:hidden md:inline sm:hidden w-full"
          />
          <Image
            src={footer_mobile}
            alt="footer"
            className="mt-12 lg:hidden md:hidden sm:inline w-full"
          />
          ...
          <div className="flex justify-between lg:mt-12 md:mt-6 sm:mt-12 md:flex-row ml-8 mr-8 flex-col-reverse sm:gap-8 md:gap-0">
            <p className="lg:text-sm md:text-[8px] sm:text-sm font-normal">
              © 2024 Leighbrook. All rights reserved.
            </p>
            ...
            {/* <p className='sm:inline-flex md:hidden'>© 2024 Leighbrook. All rights reserved.</p> */}
          </div>
        </div>
      </div>
    </div>
